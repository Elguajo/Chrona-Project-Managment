...
Current phase: Phase 03 — Kanban (`.progressive/phases/03-kanban.md`). Timeline and Milestones are implemented early and await the same missing browser smoke; List, Dashboard, Project workspace drawer, and standalone `/projects/[id]` route are also implemented. Templates and global keyboard navigation remain future scope.
